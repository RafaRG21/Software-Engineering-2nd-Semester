					...
					switch (smenu){
						...
						case 2:
							do{	system("cls");												
								...
								printf("Seleccione en que categoría desea buscar: ");
								scanf("%i",&ssmenu);
					...
					switch (smenu){
						...
						case 2:
							do{	 system("cls");												
								printf("*****Búsqueda*****\n");
								printf("1) Clave\n");
								printf("2) Nombre del Cine\n");
								printf("3) Género\n");
								printf("4) Tipo de Función\n");
								printf("5) Duración de la Película\n");
								printf("6) Salir\n\n");
...
plc catchapelicula(){
	...
	strtok(y.clave,"\n");
	printf("Captura el nombre del Cine: ");
	fflush(stdin);
...
plc busquedaclave(plc y, char buscar[50]){
char edit[50];
    if(strcmp(y.clave,buscar)==0){
		printfpelicula(y);
		
		printf("Inserte el nuevo nombre del cine: ");
		fflush(stdin);
		fgets(edit,50,stdin);
		strtok(edit,"\n");
		strcpy(y.name,edit);
